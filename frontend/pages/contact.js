...
const Contact = () => {
  return (
    <>
      <div className="md:mx-20 mx:4 py-14">
        <div className="container ">
          <div className="lg:flex">
            <div className="xl:w-2/5 lg:w-2/5 bg-teal-700 py-16 xl:rounded-bl rounded-tl rounded-tr xl:rounded-tr-none">
                  ...
                  <div className="w-full  mb-6 ">
                    <div className="flex flex-col">
                      ...
                      <input
                        ...
                        name="full_name"
                        type="text"
                        className="focus:outline-none focus:border focus:border-teal-700 font-normal  h-10 flex items-center pl-3 text-sm border-gray-300 rounded border"
                        placeholder
                      />
                    </div>
                  </div>
                ...
                <div className="w-full mt-6">
                  <div className="flex flex-col">
                    ...
                    <textarea
                      placeholder
                      name="message"
                      className="border-gray-300 border mb-4 rounded py-2 text-sm outline-none resize-none px-3 focus:border focus:border-teal-700"
                      rows={8}
                      id="message"
                      defaultValue={""}
                    />
                  ...
                  <button
                    type="submit"
                    className="focus:outline-none bg-teal-700 transition duration-150 ease-in-out hover:bg-teal-600 rounded text-white px-8 py-3 text-sm leading-6"
                  >
                    Submit
                  </button>
                </div>
