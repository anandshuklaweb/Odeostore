        ...
        <div className="dark:bg-gray-900">
          <div className="flex flex-col lg:flex-row items-stretch justify-between lg:px-0 px-6 lg:py-20 py-8 2xl:mx-auto 2xl:container">
            <div className="z-30 relative lg:w-1/2">
              <div className="hidden dark:bg-teal-800 bg-gray-100 w-full lg:w-10/12 lg:h-full lg:flex justify-end items-center">
              ...
              <div className="absolute top-0 dark:bg-teal-800 bg-gray-100 md:h-96 w-full hidden md:block lg:hidden"></div>
            ...
            <div className="bg-gray-100 dark:bg-teal-800 lg:w-1/2 lg:ml-12 lg:p-14 p-8 flex items-center">
              <div>
                ...
                <p className="dark:text-gray-300 md:w-9/12 lg:w-11/12 xl:w-10/12 2xl:9/12 text-base leading-normal text-gray-600 mt-5">
                  Get inspired by our curated selection of luxiwood interiors.
                  We hope get inspired to have luxiwood interior yourself.
                  You’ll find tips here where you can buy a lot of cool
